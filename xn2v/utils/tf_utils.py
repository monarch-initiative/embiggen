...
class TFUtilities(object):
    """Class that stores utility or helper methods, designed to ease interactions with tensorflow objects."""

    @staticmethod
    def gets_tensor_length(tensor: Optional[Union[tf.data.Dataset, tf.RaggedTensor]]) -> int:
