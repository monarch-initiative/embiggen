"""Edge-label prediction model based on LLeaves.""" ""
from typing import Dict, Union, Any, List
from lightgbm import LGBMClassifier
from lleaves import Model as LLeavesClassifier
...
class LLeavesEdgeLabelPrediction(SklearnLikeEdgeLabelPredictionAdapter):
    """Edge-label prediction model based on LLeaves."""

    def __init__(
        self,
        path: str = "lgb_edge_label_classifier.txt",
        ...
        **kwargs: Dict,
        ...
        """Build a LLeaves Edge-label prediction model.
