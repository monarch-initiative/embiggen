"""Submodule wrapping SGD for edge label prediction."""
from typing import Dict, Any
from sklearn.linear_model import SGDClassifier
from .sklearn_edge_label_prediction_adapter import SklearnEdgeLabelPredictionAdapter


class SGDEdgeLabelPrediction(SklearnEdgeLabelPredictionAdapter):
    """Create wrapper over Sklearn SGD classifier for edge label prediction."""
    ...
    def __init__(
        ...
        """Create the SGD for Edge Label Prediction."""
        self._loss = loss,
