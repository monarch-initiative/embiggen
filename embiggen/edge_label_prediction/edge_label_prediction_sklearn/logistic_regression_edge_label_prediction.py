"""Submodule wrapping Logistic Regression for edge label prediction."""
from typing import Dict, Any
from sklearn.linear_model import LogisticRegression
from .sklearn_edge_label_prediction_adapter import SklearnEdgeLabelPredictionAdapter


class LogisticRegressionEdgeLabelPrediction(SklearnEdgeLabelPredictionAdapter):
    """Create wrapper over Sklearn Logistic Regression classifier for edge label prediction."""
    ...
    def __init__(
        ...
        """Create the Logistic Regression for Edge Label Prediction."""
        super().__init__(
            LogisticRegression(
                penalty = penalty,
                dual = dual,
