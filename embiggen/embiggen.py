...
class Embiggen:
    ...
    def fit(
        ...
        if method == 'skipgram':
            ...
            raise ValueError(
                "embedding method must be one of skipgram, cbow, glove")
    ...
    def transform(self, positives: EnsmallenGraph, negatives: EnsmallenGraph) -> Tuple[np.ndarray, np.ndarray]:
    ...
    def transform_nodes(self, positives: EnsmallenGraph, negatives: EnsmallenGraph) -> Tuple[
