"""Submodule wrapping SGD for node label prediction."""
from typing import Dict, Any
from sklearn.linear_model import SGDClassifier
from .sklearn_node_label_prediction_adapter import SklearnNodeLabelPredictionAdapter


class SGDNodeLabelPrediction(SklearnNodeLabelPredictionAdapter):
    """Create wrapper over Sklearn SGD classifier for node label prediction."""
    ...
    def __init__(
        ...
        """Create the SGD for node Label Prediction."""
        self._loss = loss,
