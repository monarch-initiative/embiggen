"""Second order Jaccard TensorFlow model."""
from typing import Optional, Dict, Any

from ensmallen import Graph
from embiggen.sequences.tensorflow_sequences import EdgeJaccardSequence, AncestorsJaccardSequence
from embiggen.embedders.tensorflow_embedders.second_order_line import SecondOrderLINETensorFlow


class SecondOrderJaccard(SecondOrderLINETensorFlow):
    """Second order Jaccard TensorFlow model."""
