...
class GCNEdgePredictionTrainingSequence(Sequence):
    ...
    def __getitem__(self, idx: int) -> Tuple[np.ndarray, np.ndarray]:
        ...
        """
        sources, _, destinations, _, edge_types, edge_metrics, labels = self.get_graph().get_edge_prediction_mini_batch(
        ...
        edge_type_features = self._prediction_sequence.get_edge_type_features(edge_types) if self.has_edge_type_features() else []
