"""Keras Sequence for running Neural Network on graph edge jaccard prediction."""
...
class EdgeJaccardSequence(Sequence):
    """Keras Sequence for running Neural Network on graph edge jaccard prediction."""
    ...
    def __getitem__(self, idx: int) -> Tuple[np.ndarray, np.ndarray]:
        ...
        """
        sources, destinations, scores = self._graph.get_edge_jaccard_mini_batch(
