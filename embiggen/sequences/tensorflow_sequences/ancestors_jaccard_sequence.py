"""Keras Sequence for running Neural Network on graph ancestor Jaccard prediction."""
...
class AncestorsJaccardSequence(Sequence):
    """Keras Sequence for running Neural Network on graph ancestor Jaccard prediction."""
    ...
    def __init__(
        ...
        root_node_name: str
            The node of the graph from which to start the
        ...
        self._graph = graph
        self._bfs = graph.get_breadth_first_search_from_node_names(
            src_node_name=root_node_name,
    ...
    def __getitem__(self, idx: int) -> Tuple[np.ndarray, np.ndarray]:
        ...
        """
        sources, destinations, scores = self._graph.get_ancestors_jaccard_mini_batch(
