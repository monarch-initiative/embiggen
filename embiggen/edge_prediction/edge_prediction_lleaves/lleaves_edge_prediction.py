"""Edge prediction model based on LLeaves.""" ""
...
class LLeavesEdgePredictionModel(SklearnLikeEdgePredictionAdapter):
    """Edge prediction model based on LLeaves."""

    def __init__(
        self,
        path: str = "lgb_edge_classifier.txt",
        ...
        **kwargs: Dict,
        ...
        """Build a LLeaves Edge prediction model.
