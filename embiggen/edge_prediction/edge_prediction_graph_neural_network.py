...
class EdgePredictionGraphNeuralNetwork:
    ...
    def __init__(
        ...
        number_of_units_per_submodule_hidden_layer: Optional[Union[int, List[int], List[List[int]]]] = 64,
        number_of_units_per_body_hidden_layer: Optional[Union[int, List[int]]] = 64,
        number_of_units_per_header_hidden_layer: Optional[Union[int, List[int], List[List[int]]]] = 64,
        number_of_submodule_hidden_layers: Optional[Union[int, List[int]]] = 1,
        number_of_body_hidden_layers: Optional[int] = 1,
        number_of_header_hidden_layers: Optional[Union[int, List[int]]] = 1,
