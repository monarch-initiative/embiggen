...
def check_alls(module):
    ...
    if len(missings) > 0:
        error_msg += "in the __all__ of module '{}' the following values '{}' cannot be imported".format(
    ...
    if len(alls) != len(set(alls)):
        ...
        error_msg += "is in the __all__ of module '{}' the following keys are duplicated '{}'".format(
