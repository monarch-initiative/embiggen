...
from embiggen.text_encoder import TextEncoder
...
class TestCsvTextEncoder(TestCase):
    ...
    def testClassInitializationPayloadIndex(self):
        ...
        self.assertRaises(TypeError, TextEncoder, self.infile2, 'two', None, None, 'words')

    def testClassInitializationHeader(self):
        """Tests the initialization of the class for the header parameter."""

        # when passing a non-integer
        self.assertRaises(TypeError, TextEncoder, self.infile2, 2, 'two', None, 'words')
    ...
    def testClassInitializationDelimiter(self):
        ...
        self.assertRaises(TypeError, TextEncoder, self.infile2, 2, None, [','], 'words')
